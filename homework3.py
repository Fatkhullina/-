...
#                 salary_min = int(float(salary_split[0] + salary_split[1]))
#                 salary_max = int(float(salary_split[3] + salary_split[4]))
#                 currency = salary_split[5]
#             elif len(salary_split) == 4:
#                 if salary_split[0] == 'от':
#                     salary_min = int(float(salary_split[1] + salary_split[2]))
#                     salary_max = None
#                     currency = salary_split[3]
#                 else:
#                     salary_min = None
#                     salary_max = int(float(salary_split[1].replace('–', '') + salary_split[2].replace('–', '')))
#                     currency = salary_split[3]
#
...
#
#         i = 0
#         for doc in vac.find({'link': vacancy_link}):
#             i = 1
#
#         if i == 0:
#             vac.insert_one(vacancy_info)
#
#         print()
#
#
...
# ss = 'Data Analyst \\ Аналитик данных (BI, SQL, Python, Data Science)'
# j = 0
# for doc in vac.find({}):
#     print(doc)
sal = 50000
# def salary(sal):
for doc in vac.find({'$or':
                         [{'salary_min': {'$gte': 50000}}, {'salary_max': {'$gte': 50000}}]
                     }):
    print(doc)